...
type AdminAPI interface {
	...
	QueryNodesInfo(ctx context.Context) (uint64, []*PBNodeInfo, error)
	AddNode(ctx context.Context, nodeId uint64, loc string) (uint64, error)
	UpdateNode(ctx context.Context, nodeId uint64, loc string) error
