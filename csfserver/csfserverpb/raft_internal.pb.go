...
import leasepb "github.com/catyguan/csf/lease/leasepb"
...
type InternalRaftRequest struct {
	...
	LeaseGrant               *leasepb.LeaseGrantRequest              `protobuf:"bytes,8,opt,name=lease_grant,json=leaseGrant" json:"lease_grant,omitempty"`
	LeaseRevoke              *leasepb.LeaseRevokeRequest             `protobuf:"bytes,9,opt,name=lease_revoke,json=leaseRevoke" json:"lease_revoke,omitempty"`
...
func (m *InternalRaftRequest) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.LeaseGrant == nil {
				m.LeaseGrant = &leasepb.LeaseGrantRequest{}
			}
		...
		case 9:
			...
			if m.LeaseRevoke == nil {
				m.LeaseRevoke = &leasepb.LeaseRevokeRequest{}
			}
...
var fileDescriptorRaftInternal = []byte{
	...
	,
}
